...
* Enter the project name <tt>org.eclipselabs.spray.examples.busmod</tt>.
...
After finishing the project wizard the Spray model editor opens. Paste this model into file <tt>busmod.spray</tt>:
...
p. 
After saving the model the editor sources will be automatically generated to the <tt>src-gen</tt> folder of the project.
...
* Right-click on the <tt>src</tt> folder, choose _File / New / Other -> Examples / Graphiti / Graphiti Diagram_
