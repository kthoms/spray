/*************************************************************************************
 *
 * Generated on Mon Aug 29 17:53:14 CEST 2011 by XSpray FeatureProvider.xtend
 *
...
public class mod4jFeatureProviderBase extends DefaultFeatureProvider {
    ...
    public ICreateFeature[] getCreateFeatures() {
        return new ICreateFeature[] { new mod4jCreateBusinessClassFeature(this), new mod4jCreateBusinessClasspropertiesBoolPropertyFeature(this),
                ...
                new mod4jCreateBusinessClasspropertiesDecimalPropertyFeature(this), new mod4jCreateBusinessClassbusinessRulesUniqueRuleFeature(this),
    ...
    public ICreateConnectionFeature[] getCreateConnectionFeatures() {
        return new ICreateConnectionFeature[] { new mod4jCreateAssociationFeature(this), new mod4jCreateBusinessClasssuperclassFeature(this), };
    }

    /*
     * (non-Javadoc)
     * 
     * @see org.eclipse.graphiti.features.edit.IFeatureProvider#getDeleteFeatures()
     */
    @Override
    ...
    public ICustomFeature[] getCustomFeatures(ICustomContext context) {
        ...
        if (isBusinessClass(bo)) {
            return new ICustomFeature[] { new mod4jCustomDoWithBusinessClassFeature(this) // true
            };
        }
        if (isAssociation(bo)) {
