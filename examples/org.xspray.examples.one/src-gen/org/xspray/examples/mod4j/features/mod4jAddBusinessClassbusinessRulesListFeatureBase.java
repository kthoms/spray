...
public class mod4jAddBusinessClassbusinessRulesListFeatureBase extends  AbstractAddShapeFeature {
    ...
    public mod4jAddBusinessClassbusinessRulesListFeatureBase(IFeatureProvider fp) {
        super(fp);
    }
	...
	public PictogramElement add(IAddContext context) {
		final AbstractBusinessRule addedModelElement = (AbstractBusinessRule) context.getNewObject();
        ...
        for (Shape shape : textbox.getChildren()) {
           GraphicsAlgorithm graphicsAlgorithm = shape.getGraphicsAlgorithm();
	        ...
	        if( modelType != null && modelType.equals("AbstractBusinessRule") ){
	        	found = shape; index = i; 
	        }
            i++;
		}
	    ...
	    Graphiti.getPeService().setPropertyValue(newShape, "MODEL_TYPE", "AbstractBusinessRule");
		...
		Text text = gaService.createDefaultText(getDiagram(), newShape, addedModelElement.getName()); 
	...
	public boolean canAdd(IAddContext context) {
		...
		if (newObject instanceof AbstractBusinessRule) {
