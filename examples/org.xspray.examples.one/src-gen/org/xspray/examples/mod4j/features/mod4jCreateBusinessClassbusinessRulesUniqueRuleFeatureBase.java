...
public class mod4jCreateBusinessClassbusinessRulesUniqueRuleFeatureBase extends AbstractCreateFeature {

    private static final String TITLE = "Create UniqueRule";
    private static final String USER_QUESTION = "Enter new UniqueRule name";

    public mod4jCreateBusinessClassbusinessRulesUniqueRuleFeatureBase(IFeatureProvider fp) {
        // set name and description of the creation feature
        super(fp, "UniqueRule", "Create UniqueRule");
    }
    ...
    public Object[] create(ICreateContext context) {
        ...
        // create UniqueRule
        UniqueRule newDomainObject = BusinessDomainDslFactory.eINSTANCE.createUniqueRule();
