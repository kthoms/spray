...
public class mod4jCreateBusinessClasspropertiesIntegerPropertyFeatureBase extends AbstractCreateFeature {

    private static final String TITLE = "Create IntegerProperty";
    private static final String USER_QUESTION = "Enter new IntegerProperty dataType";

    public mod4jCreateBusinessClasspropertiesIntegerPropertyFeatureBase(IFeatureProvider fp) {
        // set name and description of the creation feature
        super(fp, "IntegerProperty", "Create IntegerProperty");
    }
    ...
    public Object[] create(ICreateContext context) {
        // ask user for IntegerProperty name
        ...
        // create IntegerProperty
        IntegerProperty newDomainObject = BusinessDomainDslFactory.eINSTANCE.createIntegerProperty();
