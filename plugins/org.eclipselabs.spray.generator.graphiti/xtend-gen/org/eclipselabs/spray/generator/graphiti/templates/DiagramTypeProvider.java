...
public class DiagramTypeProvider extends FileGenerator {
  ...
  public StringConcatenation mainFile(final Diagram diagram, final String className) {
    ...
    _builder.newLine();
    _builder.append("import org.eclipse.graphiti.platform.IDiagramEditor;");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected IToolBehaviorProvider toolBehaviorProvider;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("@Inject");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("protected IFeatureProvider      featureProvider;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("         ");
    _builder.append("return new IToolBehaviorProvider[] { toolBehaviorProvider };");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public void init(Diagram diagram, IDiagramEditor diagramEditor) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("super.init(diagram, diagramEditor);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("super.setFeatureProvider(featureProvider);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
