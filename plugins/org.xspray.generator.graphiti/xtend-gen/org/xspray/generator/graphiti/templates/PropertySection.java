...
public class PropertySection extends FileGenerator {
  ...
  public StringConcatenation mainFile(final EAttribute eAttribute, final String className) {
    ...
    String _importPackage = this.diagram.getImportPackage();
    ...
    _builder.newLineIfNotEmpty();
    {
      if (isEnum) {
        ...
        String _name_4 = _eAttributeType_3.getName();
    ...
    _builder.newLine();
    {
      ...
      if (_operator_not) {
        ...
        _builder.newLine();
        {
          ...
          String _name_8 = _eAttributeType_4.getName();
          boolean _operator_equals_1 = ObjectExtensions.operator_equals(_name_8, "EString");
          if (_operator_equals_1) {
            ...
            String _name_9 = _eAttributeType_5.getName();
            boolean _operator_equals_2 = ObjectExtensions.operator_equals(_name_9, "EInt");
          ...
          if (_operator_and) {
            {
              ...
              String _name_10 = _eAttributeType_6.getName();
              boolean _operator_equals_3 = ObjectExtensions.operator_equals(_name_10, "EBoolean");
              if (_operator_equals_3) {
                ...
                String _name_11 = _eAttributeType_7.getName();
                boolean _operator_equals_4 = ObjectExtensions.operator_equals(_name_11, "EString");
                if (_operator_equals_4) {
                  ...
                  String _name_12 = _eAttributeType_8.getName();
                  boolean _operator_equals_5 = ObjectExtensions.operator_equals(_name_12, "EInt");
      ...
      if (_operator_or_4) {
        ...
        _builder.newLine();
        {
          if (isEnum) {
            ...
            String _name_13 = _eAttributeType_9.getName();
            _builder.append(_name_13, "");
            _builder.append("> values = ");
            EDataType _eAttributeType_10 = eAttribute.getEAttributeType();
            String _name_14 = _eAttributeType_10.getName();
            ...
            String _name_15 = _eAttributeType_11.getName();
            ...
            boolean _operator_equals_6 = ObjectExtensions.operator_equals(_name_16, "EBoolean");
        ...
        _builder.newLineIfNotEmpty();
        {
          if (isEnum) {
            ...
            if (isBoolean) {
              ...
              boolean _startsWith = _name_22.startsWith("is");
              if (_startsWith) {
                String _name_23 = eAttribute.getName();
                _xifexpression = _name_23;
              } else {
                String _name_24 = eAttribute.getName();
          ...
          if (_operator_and_1) {
            {
              if (isEnum) {
                ...
                String _name_25 = _eAttributeType_13.getName();
                _builder.append(_name_25, "	");
                _builder.append(" value = ");
                EDataType _eAttributeType_14 = eAttribute.getEAttributeType();
                String _name_26 = _eAttributeType_14.getName();
                ...
                if (isBoolean) {
                  ...
                  boolean _startsWith_1 = _name_28.startsWith("is");
                  if (_startsWith_1) {
                    String _name_29 = eAttribute.getName();
                    _xifexpression_1 = _name_29;
                  } else {
                  ...
                  _builder.append("\t\t\t\t    \t");
                  _builder.append("bc.set");
                  String _name_31 = eAttribute.getName();
