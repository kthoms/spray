 ...
 *   <li>{@link org.xspray.mm.xspray.impl.MetaClassImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetaClassImpl extends SprayElementImpl implements MetaClass {
	...
	public EClass getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XsprayPackage.META_CLASS__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EClass newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XsprayPackage.META_CLASS__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XsprayPackage.META_CLASS__TYPE:
