...
public abstract class SprayElementImpl extends EObjectImpl implements SprayElement {
	...
	public Container getContainer() {
		if (eContainerFeatureID() != XsprayPackage.SPRAY_ELEMENT__CONTAINER) return null;
	...
	public NotificationChain basicSetContainer(Container newContainer, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newContainer, XsprayPackage.SPRAY_ELEMENT__CONTAINER, msgs);
		return msgs;
	}
	...
	public void setContainer(Container newContainer) {
		if (newContainer != eInternalContainer() || (eContainerFeatureID() != XsprayPackage.SPRAY_ELEMENT__CONTAINER && newContainer != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, XsprayPackage.SPRAY_ELEMENT__CONTAINER, newContainer, newContainer));
	}
